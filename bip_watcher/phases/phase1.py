...
from bip_watcher.parsing.link_extraction import (
    iter_links_fast,
    should_skip_href,
    anchor_is_ignored,
)
...
async def phase1_discover(
    ...
    # Try multiple candidate start URLs
                ...
                if detect_js_app(html0):
                    ...
                    try:
                        base_site = urlunparse(
                            (urlparse(final0).scheme, urlparse(final0).netloc, "/", "", "", "")
                        )
